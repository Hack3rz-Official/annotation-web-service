...
class AnnotationServiceTest {
    ...
    void whenValidJavaCode_thenReturnLexedTokens() {
        ...
        assertEquals(expectedLexingResult, annotationService.serializeLexingTokens(annotationService.annotateCode(code, JAVA)));
    }
    ...
    void whenValidKotlinCode_thenReturnLexedTokens() {
        ...
        assertEquals(expectedLexingResult, annotationService.serializeLexingTokens(annotationService.annotateCode(code, KOTLIN)));
    }
    ...
    void whenValidPython3Code_thenReturnLexedTokens() {
        ...
        assertEquals(expectedLexingResult, annotationService.serializeLexingTokens(annotationService.annotateCode(code, PYTHON)));
    }
    ...
    void whenJavaCodeCanNotBeLexed_thenFailGracefully() {
        ...
        assertTrue(annotationService.serializeLexingTokens(annotationService.annotateCode(code, JAVA)).isEmpty());
    }
}